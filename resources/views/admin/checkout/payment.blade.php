...
<script type="text/javascript">
    document.getElementById('pay-button').onclick = function () {
        // SnapToken yang diambil dari Controller sebelumnya
        snap.pay('{{ $transaction->snap_token }}', {
            // Callback ketika pembayaran berhasil
            onSuccess: function(result){
                window.location.href = "/success?order_id={{ $transaction->order_id }}";
            },
            // Callback ketika status tertunda
    ...
    // Auto-trigger (Otomatis klik tombol saat halaman termuat)
